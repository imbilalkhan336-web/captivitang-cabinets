...
export const BRANDS = [
    ...
    { name: 'J&K', slug: 'jk', logo: '/images/brand-img/jk-logo.png', blurb: 'Affordable all-wood cabinetry', lines: [] },
    { name: 'Modernform', slug: 'modernform', logo: '/images/brand-img/modernform-logo.png', blurb: 'Sleek contemporary designs', lines: [] },
    { name: 'Diamond', slug: 'diamond', logo: '/images/brand-img/diamond-logo.jpg', blurb: 'Trusted American craftsmanship', lines: [] },
    { name: 'Decora', slug: 'decora', logo: '/images/brand-img/decora-cabinet.jpg', blurb: 'Designer styles & finishes', lines: [] },
    { name: 'Mantra', slug: 'mantra', logo: '/images/brand-img/mantra-logo.png', blurb: 'Modern frameless cabinets', lines: [] },
    { name: 'Tribeca', slug: 'tribeca', logo: '/images/brand-img/tribeca-logo.png', blurb: 'Urban-inspired cabinetry', lines: [] },
    { name: 'KCD', slug: 'kcd', logo: '/images/brand-img/kcd-logo.svg', blurb: 'Value-driven ready-to-assemble', lines: [] },
    { name: 'USCD', slug: 'uscd', logo: '/images/brand-img/uscd-logo.jpg', blurb: 'US Cabinet Depot essentials', lines: [] },
];
