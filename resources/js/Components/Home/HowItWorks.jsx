...
function StepCard({ num, title, description, cta, href }) {
    return (
        <div className="relative flex flex-col h-full rounded-2xl bg-white border border-[#14304E]/10 shadow-[0_10px_30px_rgba(20,48,78,0.06)] p-7 lg:p-8 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_22px_48px_rgba(20,48,78,0.12)]">
            {/* Number badge */}
            <div className="relative z-10 mb-5 flex items-center gap-4">
                ...
                <span className="h-px flex-1 bg-gradient-to-r from-[#14304E]/15 to-transparent" aria-hidden="true" />
            </div>

            <h3 className="font-display text-xl lg:text-2xl font-bold text-[#14304E] tracking-tight">
                {title}
            </h3>
            <p className="mt-3 text-[#14304E]/70 text-[15px] leading-relaxed flex-1">
                {description}
            </p>
...
export default function HowItWorks() {
    return (
        <section className="relative bg-white py-16 lg:py-24 overflow-hidden" aria-label="How it works">
            ...
            <div className="pointer-events-none absolute -bottom-24 -left-24 w-80 h-80 rounded-full bg-[#14304E]/10 blur-3xl" aria-hidden="true" />
            ...
            <div className="relative max-w-container mx-auto px-6 lg:px-8">
                ...
                <div className="text-center max-w-2xl mx-auto">
                    ...
                    <h2 className="mt-3 font-display text-3xl md:text-4xl lg:text-[42px] font-bold text-[#14304E] tracking-tight leading-tight">
                ...
                <div className="relative mt-14">
                    ...
                    <div
                        className="hidden lg:block absolute top-[52px] left-[16%] right-[16%] h-px border-t-2 border-dashed border-[#14304E]/15"
                        aria-hidden="true"
                    />
